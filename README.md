...
<h2>活動カレンダー / CONTRIBUTION CALENDAR</h2>
<table>
  <tr>
    <td width="24%" align="center" valign="middle">
      <img src="./assests/miku%20nod%20calendar.gif" height="250" alt="Hatsune Miku nodding beside the contribution calendar" />
    </td>
    <td width="76%" valign="middle">
      <!-- Generated by the isocalendar plugin in .github/workflows/metrics.yml. -->
      <img src="./metrics.plugin.isocalendar.svg" width="100%" alt="Six-month isometric GitHub contribution calendar" />
    </td>
  </tr>
</table>
